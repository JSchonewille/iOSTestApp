...
extension AppDelegate: CLLocationManagerDelegate {
    ...
    func locationManager(manager: CLLocationManager!,
        ...
        inRegion region: CLBeaconRegion!) {
            let testScan = self.storyboard.instantiateViewControllerWithIdentifier("TestScan") as TestScan
            let testScan:TestScan = window!.rootViewController as TestScan
            testScan.beacons = beacons as [CLBeacon]?
            testScan.tableView!.reloadData()
